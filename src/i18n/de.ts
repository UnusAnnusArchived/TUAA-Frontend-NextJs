const de = {
  ...
  pages: {
    ...
    downloads: "Downloads",
    download_specific_episode: "Download eine bestimmt Episode",
    download_epissode: "Download {name}",
    translate_tuaa: "Übersetzen TUAA",
  },
  common: {
    cancel: "Absagen",
    close: "Schließen",
    ...
    account: {
      ...
      password: "Kennwort",
      confirm_password: "Bestätigen Kennwort",
    },
  },
  menu: {
    language: "Sprache",
  ...
  login: {
    ...
    logins_disabled_link_text: "unseren Discord",
  ...
  profile: {
    ...
    reset: {
      header: "Zurücksetzen",
      email: {
        action: "Email Zurücksetzen Senden",
        disabled: "Email Zurücksetzen Gesendet",
        dialog: {
      ...
      password: {
        action: "Passwort Zurücksetzen Senden",
        disabled: "Passwort Zurücksetzen Gesendet",
      },
    },
    logout: {
      action: "Ausloggen",
  ...
  settings: {
    account_settings: {
      description: "Suchen Sie nach Kontoeinstellungen? Sie sind auf der {link}.",
  ...
  downloads: {
    ...
    specific_episode_link: {
      name: "Download eine bestimmte Episode",
      description: "Download Sie eine bestimmte Episode herunter, ohne ein Programm zu verwenden",
    },
    tuaa_downloader_link: {
      name: "Der Unus Annus Downloader",
      description: "Eine einfache Möglichkeit, eine unserer Episoden massenhaft herunterzuladen",
    },
    tuaa_node_api_link: {
  ...
  comments: {
    ...
    errors: {
      ...
      no_comments: "Keine Kommentare gefunden. Wie wäre es, wenn Sie das Gespräch beginnen?",
    },
  },
  patreon_popup: {
