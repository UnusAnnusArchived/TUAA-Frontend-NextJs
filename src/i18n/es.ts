...
***REMOVED***
  comments: ***REMOVED***
    ...
    loggedOut: "Tu Necesitas Logearte para comentar en este video",
***REMOVED***
  seasons: ***REMOVED***
    season1: "Temporada 1",
    season2: "Especiales",
...
***REMOVED***
  ...
  ***REMOVED***
    username: "Nombre de usuario",
    email: "Correo electronico",
    dataTitle: "Datos retenidos sobre su perfil",
    logout: ***REMOVED***
      ...
      error: "Ha habido un error tratando de cerrar la sesión",
  ***REMOVED***
***REMOVED***
  errors: ***REMOVED***
